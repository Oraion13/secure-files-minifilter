...
Abstract:
    ...
    This is the main module of the SecretFiles miniFilter driver.
...
VOID
SecretFilesInstanceTeardownStart (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _In_ FLT_INSTANCE_TEARDOWN_FLAGS Flags
    );

VOID
SecretFilesInstanceTeardownComplete (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _In_ FLT_INSTANCE_TEARDOWN_FLAGS Flags
    );
...
NTSTATUS
SecretFilesInstanceQueryTeardown (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _In_ FLT_INSTANCE_QUERY_TEARDOWN_FLAGS Flags
    );

FLT_PREOP_CALLBACK_STATUS
SecretFilesPreOperation (
...
FLT_PREOP_CALLBACK_STATUS
SecretFilesPreOperationNoPostOperation (
    _Inout_ PFLT_CALLBACK_DATA Data,
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _Flt_CompletionContext_Outptr_ PVOID *CompletionContext
    );
...
BOOLEAN
SecretFilesDoRequestOperationStatus(
...
#pragma alloc_text(PAGE, SecretFilesUnload)
#pragma alloc_text(PAGE, SecretFilesInstanceQueryTeardown)
#pragma alloc_text(PAGE, SecretFilesInstanceSetup)
#pragma alloc_text(PAGE, SecretFilesInstanceTeardownStart)
#pragma alloc_text(PAGE, SecretFilesInstanceTeardownComplete)
#endif
...
CONST FLT_REGISTRATION FilterRegistration = {
    ...
    SecretFilesUnload,                           //  MiniFilterUnload

    SecretFilesInstanceSetup,                    //  InstanceSetup
    SecretFilesInstanceQueryTeardown,            //  InstanceQueryTeardown
    SecretFilesInstanceTeardownStart,            //  InstanceTeardownStart
    SecretFilesInstanceTeardownComplete,         //  InstanceTeardownComplete
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesInstanceSetup: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesInstanceQueryTeardown: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesInstanceTeardownStart: Entered\n") );
}
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesInstanceTeardownComplete: Entered\n") );
}
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!DriverEntry: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesUnload: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesPreOperation: Entered\n") );
    ...
    if (SecretFilesDoRequestOperationStatus( Data )) {
        ...
        if (!NT_SUCCESS(status)) {
            ...
            PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                          ("SecretFiles!SecretFilesPreOperation: FltRequestOperationStatusCallback Failed, status=%08x\n",
                           status) );
        }
    }
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesOperationStatusCallback: Entered\n") );

    PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                  ("SecretFiles!SecretFilesOperationStatusCallback: Status=%08x ctx=%p IrpMj=%02x.%02x \"%s\"\n",
                   OperationStatus,
                   RequesterContext,
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesPostOperation: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("SecretFiles!SecretFilesPreOperationNoPostOperation: Entered\n") );
